module.exports = {
  ...
  sopFetchTimeout: process.env.SOP_FETCH_TIMEOUT || 0, // SOP fetch timeout
  startDate: process.env.START_DATE?process.env.START_DATE:"Wed Jun 8 2016 22:00:00 GMT+0100 (BST)", // The Master SWITCH
